...
public class CpGrupoMovimientoLogic implements ICpGrupoMovimientoLogic {
    public List<CpGrupoMovimiento> getCpGrupoMovimiento()
        throws Exception {
        List<CpGrupoMovimiento> list = new ArrayList<CpGrupoMovimiento>();
    ...
    public void deleteCpGrupoMovimiento(Long idGrupoMovimiento)
        ...
        List<CpMovimiento> cpMovimientos = null;
        entity = getCpGrupoMovimiento(idGrupoMovimiento);
    ...
    public List<CpGrupoMovimientoDTO> getDataCpGrupoMovimiento()
        throws Exception {
        try {
            List<CpGrupoMovimiento> cpGrupoMovimiento = JPADaoFactory.getInstance()
                                                                     .getCpGrupoMovimientoDAO()
                                                                     .findAll(0);

            List<CpGrupoMovimientoDTO> cpGrupoMovimientoDTO = new ArrayList<CpGrupoMovimientoDTO>();
    ...
    public List<CpGrupoMovimiento> findPageCpGrupoMovimiento(
        ...
        List<CpGrupoMovimiento> entity = null;
