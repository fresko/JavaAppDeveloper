...
public class CpTipoMovimientoLogic implements ICpTipoMovimientoLogic {
    public List<CpTipoMovimiento> getCpTipoMovimiento()
        throws Exception {
        List<CpTipoMovimiento> list = new ArrayList<CpTipoMovimiento>();
    ...
    public void deleteCpTipoMovimiento(Long idTipoMovimiento)
        ...
        List<CpGrupoMovimiento> cpGrupoMovimientos = null;
        entity = getCpTipoMovimiento(idTipoMovimiento);
    ...
    public List<CpTipoMovimientoDTO> getDataCpTipoMovimiento()
        throws Exception {
        try {
            List<CpTipoMovimiento> cpTipoMovimiento = JPADaoFactory.getInstance()
                                                                   .getCpTipoMovimientoDAO()
                                                                   .findAll(0);

            List<CpTipoMovimientoDTO> cpTipoMovimientoDTO = new ArrayList<CpTipoMovimientoDTO>();
    ...
    public List<CpTipoMovimiento> findPageCpTipoMovimiento(
        ...
        List<CpTipoMovimiento> entity = null;
