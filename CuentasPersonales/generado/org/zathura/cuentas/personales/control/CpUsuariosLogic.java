...
public class CpUsuariosLogic implements ICpUsuariosLogic {
    public List<CpUsuarios> getCpUsuarios() throws Exception {
        List<CpUsuarios> list = new ArrayList<CpUsuarios>();
    ...
    public List<CpUsuariosDTO> getDataCpUsuarios() throws Exception {
        try {
            List<CpUsuarios> cpUsuarios = JPADaoFactory.getInstance()
                                                       .getCpUsuariosDAO()
                                                       .findAll(0);

            List<CpUsuariosDTO> cpUsuariosDTO = new ArrayList<CpUsuariosDTO>();
    ...
    * de busqueda voy a hacer.., ejemplo: where nombre=william o where nombre<>william,
    ...
    public List<CpUsuarios> findByCriteria(Object[] variables,
        ...
        try {
            list = JPADaoFactory.getInstance().getCpUsuariosDAO()
