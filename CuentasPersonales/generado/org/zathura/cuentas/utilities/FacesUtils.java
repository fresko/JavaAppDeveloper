 ...
 *
 */
package org.zathura.cuentas.utilities;

import org.zathura.cuentas.exceptions.ZMessManager;
...
public class FacesUtils {
    ...
    public static void resetManagedBean(String beanName) {
        getValueBinding(getJsfEl(beanName))
    ...
    public static BigInteger checkBigInteger(Object input)
        throws ZMessManager {
        if (input == null) {
            return null;
        }
    ...
    public static BigDecimal checkBigDecimal(Object input)
        throws ZMessManager {
        if (input == null) {
            return null;
        }
